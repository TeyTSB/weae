...
Emerald = {
	...
	AcrylicBorder = Color3.fromRGB(60, 120, 90),
	AcrylicGradient = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 255, 170)),
		ColorSequenceKeypoint.new(0.25, Color3.fromRGB(0, 200, 150)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 150, 120)),
		ColorSequenceKeypoint.new(0.75, Color3.fromRGB(0, 100, 80)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 40, 30)),
	},
	AcrylicNoise = 0.85,

	TitleBarLine = Color3.fromRGB(0, 180, 140),
	Tab = Color3.fromRGB(20, 60, 50),

	Element = Color3.fromRGB(0, 180, 130),
	ElementBorder = Color3.fromRGB(0, 130, 100),
	InElementBorder = Color3.fromRGB(0, 110, 90),
	ElementTransparency = 0.84,

	ToggleSlider = Color3.fromRGB(0, 255, 170),
	ToggleToggled = Color3.fromRGB(0, 255, 170),
	TransparenToggle = 0.5,

	SliderRail = Color3.fromRGB(0, 220, 160),

	DropdownFrame = Color3.fromRGB(0, 190, 140),
	DropdownHolder = Color3.fromRGB(0, 130, 90),
	DropdownBorder = Color3.fromRGB(0, 80, 60),
	DropdownOption = Color3.fromRGB(0, 255, 170),

	Keybind = Color3.fromRGB(0, 220, 160),

	Input = Color3.fromRGB(0, 220, 160),
	InputFocused = Color3.fromRGB(200, 255, 240),
	InputIndicator = Color3.fromRGB(0, 180, 130),
	InputIndicatorFocus = Color3.fromRGB(0, 255, 170),

	Dialog = Color3.fromRGB(0, 100, 80),
	DialogHolder = Color3.fromRGB(0, 80, 60),
	DialogHolderLine = Color3.fromRGB(0, 70, 50),
	DialogButton = Color3.fromRGB(0, 150, 110),
	DialogButtonBorder = Color3.fromRGB(0, 200, 140),
	DialogBorder = Color3.fromRGB(0, 130, 90),
	DialogInput = Color3.fromRGB(0, 160, 120),
	DialogInputLine = Color3.fromRGB(100, 240, 180),

	Text = Color3.fromRGB(240, 255, 240),
	SubText = Color3.fromRGB(200, 230, 210),
	Hover = Color3.fromRGB(0, 255, 170),
	HoverChange = 0.04,
},
...
Steel = {
	Name = "Steel",
	Accent = Color3.fromRGB(100, 140, 180),

	AcrylicMain = Color3.fromRGB(40, 40, 45),
	AcrylicBorder = Color3.fromRGB(70, 70, 80),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(45, 45, 50), Color3.fromRGB(25, 25, 30)),
	AcrylicNoise = 0.9,

	TitleBarLine = Color3.fromRGB(85, 85, 90),
	Tab = Color3.fromRGB(110, 110, 120),

	Element = Color3.fromRGB(80, 80, 85),
	ElementBorder = Color3.fromRGB(35, 35, 40),
	InElementBorder = Color3.fromRGB(65, 65, 70),
	ElementTransparency = 0.8,

	DropdownFrame = Color3.fromRGB(130, 130, 140),
	DropdownHolder = Color3.fromRGB(40, 40, 50),
	DropdownBorder = Color3.fromRGB(30, 30, 35),
	...
	DialogButtonBorder = Color3.fromRGB(70, 70, 75),
	DialogBorder = Color3.fromRGB(55, 55, 60),
	DialogInput = Color3.fromRGB(55, 55, 60),
	DialogInputLine = Color3.fromRGB(130, 130, 140),
},
...
Graphite = {
	...
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 30, 30), Color3.fromRGB(20, 20, 20)),
	AcrylicNoise = 0.88,
